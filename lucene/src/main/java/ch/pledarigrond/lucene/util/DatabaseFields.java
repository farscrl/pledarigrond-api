...
public class DatabaseFields {
    public static List<IndexedColumn> getDatabaseColumns() {
        return Arrays.asList(
                ...
                new IndexedColumn("deSubsemantik", FieldType.STRING_SORTED),
                new IndexedColumn("deGrammatik", FieldType.STRING_SORTED),
                new IndexedColumn("deGenus", FieldType.STRING_SORTED),
                new IndexedColumn("deStatus"),
                new IndexedColumn("deTags"),
                new IndexedColumn("rmStichwort", FieldType.STRING_SORTED),
                new IndexedColumn("rmStichwortSort", FieldType.INTEGER_SORTED),
                new IndexedColumn("rmSemantik"),
                new IndexedColumn("rmSubsemantik", FieldType.STRING_SORTED),
                new IndexedColumn("rmGrammatik", FieldType.STRING_SORTED),
                new IndexedColumn("rmGenus", FieldType.STRING_SORTED),
                new IndexedColumn("rmFlex"),
                new IndexedColumn("rmTags"),
                new IndexedColumn("rmInflectionType"),
                new IndexedColumn("rmInflectionSubtype"),
                new IndexedColumn("categories", FieldType.SEMICOLON_SEPERATED),
                new IndexedColumn("deRedirect"),
                new IndexedColumn("rmRedirect"),
                new IndexedColumn("userComment"),
                new IndexedColumn("userEmail"),
                new IndexedColumn("rmEtymologie"),
                new IndexedColumn("examples"),
                new IndexedColumn("rmPronunciation"),
