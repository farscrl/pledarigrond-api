...
public class FN {
    ...
    public static final String rmGenus = "rmGenus";
    public static final String rmFlex = "rmFlex";
    public static final String rmTags = "rmTags";
    public static final String rmRedirect = "rmRedirect";
    public static final String rmEtymologie = "rmEtymologie";
    public static final String rmPronunciation = "rmPronunciation";
    ...
    public static final String deGenus = "deGenus";
    public static final String deTags = "deTags";
    ...
    public static final String otherForm2 = "otherForm2";
    public static final String otherForm3 = "otherForm3";
    public static final String otherForm4 = "otherForm4";
}
