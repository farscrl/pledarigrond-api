...
public class TestQueryBuildersPrefix extends TestQueryBuildersBase {
	...
	public void testPrefixQueryGerman() throws InvalidQueryException, NoIndexAvailableException, BrokenIndexException {
		Page<EntryVersionDto> result = luceneIndexManager.query(IndexTestHelpers.getSearchCriteria(SearchDirection.GERMAN, SearchMethod.PREFIX, "haus"), IndexTestHelpers.getPagination());
	...
	public void testPrefixQueryRomansh() throws InvalidQueryException, NoIndexAvailableException, BrokenIndexException {
		Page<EntryVersionDto> result = luceneIndexManager.query(IndexTestHelpers.getSearchCriteria(SearchDirection.ROMANSH, SearchMethod.PREFIX, "chasa"), IndexTestHelpers.getPagination());
	...
	public void testPrefixQueryBoth() throws InvalidQueryException, NoIndexAvailableException, BrokenIndexException {
		Page<EntryVersionDto> result = luceneIndexManager.query(IndexTestHelpers.getSearchCriteria(SearchDirection.BOTH, SearchMethod.PREFIX, "chasa"), IndexTestHelpers.getPagination());
		String[] found = getStrings(FieldName.RMSTICHWORT, result);
		String[] expected = new String[] { "chasa", "chasa", "chasa", "chasan" };
		printArray(found);
		assertArrayEquals(expected, found);
