...
public class TestQueryBuildersDefault extends TestQueryBuildersBase {
	...
	public void testDefaultQueryGerman() throws InvalidQueryException, NoIndexAvailableException, BrokenIndexException {
		...
		String[] expected = new String[] {"Haus", "Haus", "Haus", "Haus", "Kranken(haus)", "Das Haus brennt", "hausen", "Haushalt"};
		printArray(found);
	...
	public void testDefaultQueryRomansh() throws InvalidQueryException, NoIndexAvailableException, BrokenIndexException {
		...
		String[] expected = new String[] { "chasa", "chasa", "chasa", "a chasa", "a chasa", "a chasa", "a chasa", "a chasa", "encunter chasa", "anavos a chasa", "fatg en chasa", "La chasa arda", "Ve a chasa!", "chasan" };
		printArray(found);
		assertArrayEquals(expected, found);
	}
	...
	public void testDefaultQueryBoth() throws InvalidQueryException, NoIndexAvailableException, BrokenIndexException {
		...
		String[] found = getStrings(FieldName.RMSTICHWORT, result);
		String[] expected = new String[] { "chasa", "chasa", "chasa", "a chasa", "a chasa", "encunter chasa", "a chasa", "a chasa", "a chasa", "La chasa arda", "Ve a chasa!", "fatg en chasa", "anavos a chasa", "chasan" };
		printArray(found);
		assertArrayEquals(expected, found);
		...
		expected = new String[] {"Haus", "Haus", "Haus", "Haus", "Kranken(haus)", "Das Haus brennt", "hausen", "Haushalt"};
		printArray(found);
		assertArrayEquals(expected, found);
	}
}
