...
public class PuterConjugationStructure {
	...
	public static final String imperativ6 = "imperativ6";

	public static final String gerundium = "gerundium";

	public static final String composedWith = "composedWith";
	...
	public static final String futurdubitativsing1 = "futurdubitativsing1";
	public static final String futurdubitativsing2 = "futurdubitativsing2";
	public static final String futurdubitativsing3 = "futurdubitativsing3";
	public static final String futurdubitativplural1 = "futurdubitativplural1";
	public static final String futurdubitativplural2 = "futurdubitativplural2";
	public static final String futurdubitativplural3 = "futurdubitativplural3";
	...
	public static final String futurdubitativsing1enclitic = "futurdubitativsing1enclitic";
	public static final String futurdubitativsing2enclitic = "futurdubitativsing2enclitic";
	public static final String futurdubitativsing3encliticm = "futurdubitativsing3encliticm";
	public static final String futurdubitativsing3encliticf = "futurdubitativsing3encliticf";
	public static final String futurdubitativplural1enclitic = "futurdubitativplural1enclitic";
	public static final String futurdubitativplural2enclitic = "futurdubitativplural2enclitic";
	public static final String futurdubitativplural3enclitic = "futurdubitativplural3enclitic";
	...
	public String[] msi = new String[] { preschentsing1, preschentsing2,
			...
			participperfectfp, imperativ1, imperativ2, imperativ3, imperativ4,
			imperativ5, imperativ6, gerundium, composedWith, futursing1,
			futursing2, futursing3, futurplural1, futurplural2, futurplural3,
			futurdubitativsing1, futurdubitativsing2, futurdubitativsing3,
			futurdubitativplural1, futurdubitativplural2, futurdubitativplural3,
			...
			futurplural1enclitic, futurplural2enclitic, futurplural3enclitic, futurdubitativsing1enclitic,
			futurdubitativsing2enclitic, futurdubitativsing3encliticm, futurdubitativsing3encliticf,
			futurdubitativplural1enclitic, futurdubitativplural2enclitic, futurdubitativplural3enclitic
	};
	...
	public PuterConjugationStructure() {
	...
	public String getImperativ3() {
		return values.get(imperativ3);
	}

	public String getImperativ4() {
		return values.get(imperativ4);
	}

	public String getImperativ5() {
		return values.get(imperativ5);
	}

	public String getImperativ6() {
		return values.get(imperativ6);
	}
	...
	public String getComposedWith() {
		return values.get(composedWith);
	}
	...
	public String getFuturdubitativsing1() {
		return values.get(futurdubitativsing1);
	}

	public String getFuturdubitativsing2() {
		return values.get(futurdubitativsing2);
	}

	public String getFuturdubitativsing3() {
		return values.get(futurdubitativsing3);
	}

	public String getFuturdubitativplural1() {
		return values.get(futurdubitativplural1);
	}

	public String getFuturdubitativplural2() {
		return values.get(futurdubitativplural2);
	}

	public String getFuturdubitativplural3() {
		return values.get(futurdubitativplural3);
	}
	...
	public String getFuturdubitativsing1Enclitic() {
		return values.get(futurdubitativsing1enclitic);
	}

	public String getFuturdubitativsing2Enclitic() {
		return values.get(futurdubitativsing2enclitic);
	}

	public String getFuturdubitativsing3EncliticM() {
		return values.get(futurdubitativsing3encliticm);
	}

	public String getFuturdubitativsing3EncliticF() {
		return values.get(futurdubitativsing3encliticf);
	}

	public String getFuturdubitativplural1Enclitic() {
		return values.get(futurdubitativplural1enclitic);
	}

	public String getFuturdubitativplural2Enclitic() {
		return values.get(futurdubitativplural2enclitic);
	}

	public String getFuturdubitativplural3Enclitic() {
		return values.get(futurdubitativplural3enclitic);
	}
	...
	public void setImperativ3(String imp1) {
		values.put(imperativ3, imp1);
	}

	public void setImperativ4(String imp2) {
		values.put(imperativ4, imp2);
	}

	public void setImperativ5(String imp1) {
		values.put(imperativ5, imp1);
	}

	public void setImperativ6(String imp2) {
		values.put(imperativ6, imp2);
	}
	...
	public void setComposedWith(String composedWith) {
		values.put(PuterConjugationStructure.composedWith, composedWith);
	}
	...
	public void setFuturdubitativsing1(String futs1) {
		values.put(futurdubitativsing1, futs1);
	}

	public void setFuturdubitativsing2(String futs2) {
		values.put(futurdubitativsing2, futs2);
	}

	public void setFuturdubitativsing3(String futs3) {
		values.put(futurdubitativsing3, futs3);
	}

	public void setFuturdubitativplural1(String futp1) {
		values.put(futurdubitativplural1, futp1);
	}

	public void setFuturdubitativplural2(String futp2) {
		values.put(futurdubitativplural2, futp2);
	}

	public void setFuturdubitativplural3(String futp3) {
		values.put(futurdubitativplural3, futp3);
	}
	...
	public void setFuturdubitativsing1Enclitic(String futs1) {
		values.put(futurdubitativsing1enclitic, futs1);
	}

	public void setFuturdubitativsing2Enclitic(String futs2) {
		values.put(futurdubitativsing2enclitic, futs2);
	}

	public void setFuturdubitativsing3EncliticM(String futs3) {
		values.put(futurdubitativsing3encliticm, futs3);
	}

	public void setFuturdubitativsing3EncliticF(String futs3) {
		values.put(futurdubitativsing3encliticf, futs3);
	}

	public void setFuturdubitativplural1Enclitic(String futp1) {
		values.put(futurdubitativplural1enclitic, futp1);
	}

	public void setFuturdubitativplural2Enclitic(String futp2) {
		values.put(futurdubitativplural2enclitic, futp2);
	}

	public void setFuturdubitativplural3Enclitic(String futp3) {
		values.put(futurdubitativplural3enclitic, futp3);
	}
	...
	public String getValue(String key) {
		switch (key) {
			...
			case imperativ3:
				return getImperativ3();
			case imperativ4:
				return getImperativ4();
			case imperativ5:
				return getImperativ5();
			case imperativ6:
				return getImperativ6();
			case gerundium:
				return getGerundium();
			case composedWith:
				return getComposedWith();
			case futursing1:
			...
			case futurdubitativsing1:
				return getFuturdubitativsing1();
			case futurdubitativsing2:
				return getFuturdubitativsing2();
			case futurdubitativsing3:
				return getFuturdubitativsing3();
			case futurdubitativplural1:
				return getFuturdubitativplural1();
			case futurdubitativplural2:
				return getFuturdubitativplural2();
			case futurdubitativplural3:
				return getFuturdubitativplural3();
			...
			case futurdubitativsing1enclitic:
				return getFuturdubitativsing1Enclitic();
			case futurdubitativsing2enclitic:
				return getFuturdubitativsing2Enclitic();
			case futurdubitativsing3encliticm:
				return getFuturdubitativsing3EncliticM();
			case futurdubitativsing3encliticf:
				return getFuturdubitativsing3EncliticF();
			case futurdubitativplural1enclitic:
				return getFuturdubitativplural1Enclitic();
			case futurdubitativplural2enclitic:
				return getFuturdubitativplural2Enclitic();
			case futurdubitativplural3enclitic:
				return getFuturdubitativplural3Enclitic();
	...
	public String toString() {
		...
		// Futur dubitativ
		buffer.append(values.get(futurdubitativsing1));
		buffer.append("\t");
		buffer.append(values.get(futurdubitativsing2));
		buffer.append("\t");
		buffer.append(values.get(futurdubitativsing3));
		buffer.append("\t");
		buffer.append(values.get(futurdubitativplural1));
		buffer.append("\t");
		buffer.append(values.get(futurdubitativplural2));
		buffer.append("\t");
		buffer.append(values.get(futurdubitativplural3));
		buffer.append("\n");
		...
		// Composed With
		buffer.append(values.get(composedWith));
		buffer.append("\n");
		...
		buffer.append("\n");
		buffer.append(values.get(imperativ3));
		buffer.append("\t");
		buffer.append(values.get(imperativ4));
		buffer.append("\n");
		buffer.append(values.get(imperativ5));
		buffer.append("\t");
		buffer.append(values.get(imperativ6));
		buffer.append("\n");
