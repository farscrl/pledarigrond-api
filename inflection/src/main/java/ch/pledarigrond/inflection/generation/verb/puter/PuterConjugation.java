...
public class PuterConjugation extends LanguageConjugation {
    ...
    private void addReflexivePronouns() {
        ...
        // CUNDIZIONAL
        verb.getCundiziunalEnclitic().setSing1(setPronoun(PuterPronouns.pron_r_1ps, verb.getCundiziunalEnclitic().getSing1()));
        verb.getCundiziunalEnclitic().setSing2(setPronoun(PuterPronouns.pron_r_2ps, verb.getCundiziunalEnclitic().getSing2()));
        verb.getCundiziunalEnclitic().setSing3m(setPronoun(PuterPronouns.pron_r_3ps, verb.getCundiziunalEnclitic().getSing3m()));
        verb.getCundiziunalEnclitic().setSing3f(setPronoun(PuterPronouns.pron_r_3ps, verb.getCundiziunalEnclitic().getSing3f()));
        verb.getCundiziunalEnclitic().setPlural1(setPronoun(PuterPronouns.pron_r_1pp, verb.getCundiziunalEnclitic().getPlural1()));
        verb.getCundiziunalEnclitic().setPlural2(setPronoun(PuterPronouns.pron_r_2pp, verb.getCundiziunalEnclitic().getPlural2()));
        verb.getCundiziunalEnclitic().setPlural3(setPronoun(PuterPronouns.pron_r_3pp, verb.getCundiziunalEnclitic().getPlural3()));
    ...
    private void addReflexivePronounsVowel() {
        ...
        // CUNDIZIONAL
        verb.getCundiziunalEnclitic().setSing1(setPronoun(PuterPronouns.pron_r_v_1ps, verb.getCundiziunalEnclitic().getSing1()));
        verb.getCundiziunalEnclitic().setSing2(setPronoun(PuterPronouns.pron_r_v_2ps, verb.getCundiziunalEnclitic().getSing2()));
        verb.getCundiziunalEnclitic().setSing3m(setPronoun(PuterPronouns.pron_r_v_3ps, verb.getCundiziunalEnclitic().getSing3m()));
        verb.getCundiziunalEnclitic().setSing3f(setPronoun(PuterPronouns.pron_r_v_3ps, verb.getCundiziunalEnclitic().getSing3f()));
        verb.getCundiziunalEnclitic().setPlural1(setPronoun(PuterPronouns.pron_r_v_1pp, verb.getCundiziunalEnclitic().getPlural1()));
        verb.getCundiziunalEnclitic().setPlural2(setPronoun(PuterPronouns.pron_r_v_2pp, verb.getCundiziunalEnclitic().getPlural2()));
        verb.getCundiziunalEnclitic().setPlural3(setPronoun(PuterPronouns.pron_r_v_3pp, verb.getCundiziunalEnclitic().getPlural3()));
