...
public class SurmiranConjugationClasses {
    ...
    private static final List<InflectionSubType> conjugationClasses = new ArrayList<>(
            Arrays.asList(
                    ...
                    new InflectionSubType("4", "-eir", "Finiziun sin -eir (p.ex. tigneir)"),
                    ...
                    new InflectionSubType("6", "-eir", "Finiziun sin -eir (p.ex. parteir)"),
                    ...
                    new InflectionSubType("7", "-eir (esch)", "Finiziun sin -eir cun infix esch (p.ex. amplaneir)"),
                    new InflectionSubType("8", "-ar (esch)", "Finiziun sin -ar cun infix esch (p.ex. abitar)"),
