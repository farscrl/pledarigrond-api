...
public class SursilvanAdjectiveStructure {
    ...
    public String[] msi = new String[] {
            baseForm,mSingular,  predicative, fSingular,
    ...
    public SursilvanAdjectiveStructure() {
    ...
    public String getPredicative() {
        return values.get(predicative);
    }
    ...
    public void setPredicative(String p) {
        values.put(predicative, p);
    }
    ...
    public String toString() {
        ...
        buffer.append("\t");
        buffer.append(values.get(predicative));
        buffer.append("\t");
