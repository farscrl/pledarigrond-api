package ch.pledarigrond.inflection.generation.noun.surmiran;
...
public class SurmiranNounGenerator extends LanguageNounGeneration {
    ...
    public InflectionDto generateForms(String nounClassId, String baseForm) {
        ...
        InflectionSubType subType = SurmiranNounClasses.getNounInflectionClass(nounClassId);
        if (subType == null) {
    ...
    public void setSingular() {
        switch (ending) {
            ...
            case "ia":
                noun.setMSingular(root + "ia");
                noun.setFSingular(root + "eida");
                break;
