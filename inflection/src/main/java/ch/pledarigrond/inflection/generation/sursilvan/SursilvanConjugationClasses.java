...
public class SursilvanConjugationClasses {
    ...
    private static final List<InflectionSubType> conjugationClasses = new ArrayList<>(
            Arrays.asList(
                    ...
                    new InflectionSubType("1x", "u–a –> a–o ", "(p.ex. cumandar)"),
                    new InflectionSubType("1y", "u–i –> a–o", "(p.ex. dumignar)"),
                    new InflectionSubType("1z", "u–a –> a–u", "(p.ex. rumplanar)"),
                    new InflectionSubType("1aa", "u–i –> a–u", "(p.ex. murmignar)"),
                    new InflectionSubType("1ab", "u–a –> i–u", "(p.ex. buntganar)"),
                    new InflectionSubType("1ac", "u(–)r –> ro", "(p.ex. duvrar)"),
                    new InflectionSubType("1ad", "er –> ra", "(p.ex. patertgar)"),
                    new InflectionSubType("1ae", "er –> ro", "(p.ex. tschuffergnar)"),
                    new InflectionSubType("1af", "ar –> re", "(p.ex. sgarflar)"),
                    new InflectionSubType("1ag", "er –> re", "(p.ex. sblundergiar)"),
                    new InflectionSubType("1ah", "ar –> ri", "(p.ex. barschar)"),
                    new InflectionSubType("1ai", "(vocal)r -> r(vocal)", "(p.ex. furschar)"),
