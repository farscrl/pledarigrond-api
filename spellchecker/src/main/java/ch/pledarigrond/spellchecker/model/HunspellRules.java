...
public enum HunspellRules {
    ...
    VALLADER_PRONOMS_OBJECTS_IMPERATIV_AFFIRMATIV("Q"),
    VALLADER_PRONOM_REFLEXIV_IMPERATIV_AFFIRMATIV_SUFFIX("R"),
    VALLADER_PRONOM_REFLEXIV_IMPERATIV_AFFIRMATIV_PREFIX("S"),
    VALLADER_FURMA_DA_CURTASCHIA("S"),
