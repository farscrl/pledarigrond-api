...
public class SursilvanPartOfSpeechListGenerator extends PartOfSpeechListGenerator {

    public SursilvanPartOfSpeechListGenerator(PgEnvironment pgEnvironment, List<String> names) {
