...
public class RumantschgrischunPartOfSpeechListGenerator extends PartOfSpeechListGenerator {

    public RumantschgrischunPartOfSpeechListGenerator(PgEnvironment pgEnvironment, List<String> names) {
