...
public class SutsilvanPartOfSpeechListGenerator extends PartOfSpeechListGenerator {

    public SutsilvanPartOfSpeechListGenerator(PgEnvironment pgEnvironment, List<String> names) {
