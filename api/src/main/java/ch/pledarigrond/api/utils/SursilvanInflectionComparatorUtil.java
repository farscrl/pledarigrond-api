...
public class SursilvanInflectionComparatorUtil {
    ...
    private int validateInflection(InflectionDto inflection) {
        ...
        nbrWrongForms += getWrongness(inflection.getVerb().getConjunctivImperfect().getSing1(), referenceVerb.getConjunctivimpsing1());
        nbrWrongForms += getWrongness(inflection.getVerb().getConjunctivImperfect().getSing2(), referenceVerb.getConjunctivimpsing2());
        nbrWrongForms += getWrongness(inflection.getVerb().getConjunctivImperfect().getSing3(), referenceVerb.getConjunctivimpsing3());
        nbrWrongForms += getWrongness(inflection.getVerb().getConjunctivImperfect().getPlural1(), referenceVerb.getConjunctivimpplural1());
        nbrWrongForms += getWrongness(inflection.getVerb().getConjunctivImperfect().getPlural2(), referenceVerb.getConjunctivimpplural2());
        nbrWrongForms += getWrongness(inflection.getVerb().getConjunctivImperfect().getPlural3(), referenceVerb.getConjunctivimpplural3());
